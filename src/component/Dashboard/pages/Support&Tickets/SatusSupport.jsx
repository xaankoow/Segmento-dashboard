...
import { filterBoxDatas, titleOfReportSupportTable } from "../../../../variables/support";
...
export default function ReportSupport() {
  ...
  return (
    <>
      ...
      <Table columnItem={titleOfReportSupportTable} rowsItem={b} rowKey={rowKey} classname={"px-9"} />
    </>
  );
}
