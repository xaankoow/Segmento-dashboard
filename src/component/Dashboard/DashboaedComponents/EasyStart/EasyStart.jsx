    ...
    return (
        <>
            ...
            <div className="flex flex-col relative mt-9 mx-7 mb-7 ">
                <div className="flex items-center justify-center bg-gold text-xl py-5 absolute w-full -top-5  rounded-t-lg z-[2] ">
                    شروع آسان
                </div>
                <div className="rounded-lg border border-lightGray EasyStartBoxContent flex flex-col  px-7">
                    ...
                    <div className="flex justify-between items-center relative  w-full h-40">
                        ...
                        <Link to={"/dashboard/buyPlanEasyToStartModal"} state={{ background: location }} className="btn-style  mb-5 absolute bottom-0 flex justify-between">
                            {" "}شروع کنیم{" "}
