...
const ItemSidebarHover = ({text,icon,textColor,textHover,iconClickHandler,index,clicked,setClicked}) => {
    ...
    return (
       <div className={`flex items-center gap-3 text-[#002145] my-5 mr-5 text-sm hover:cursor-pointer hover:text-blue ${clicked == index && "active"}  ${text.link!=""?"":"hidden"} `} onClick={setClicked} >
