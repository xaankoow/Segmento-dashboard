    ...
    <div className='top relative'>
        {
            imageSrc.map((items,index)=>{
                   return  <div id={index} className={index===activeIcon ? "bg-[#F2F5F7] nav_right_box flex items-center justify-center relative":'nav_right_box flex items-center justify-center relative'} key={index}  onClick={(e)=>{setActiveIcon(index);setActive(e)}} >
