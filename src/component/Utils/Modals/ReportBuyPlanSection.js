...
export default function ReportBuyPlanSection({ handleClose, packageUuid, show }) {
  ...
  return (
    ...
    // className={"myModal"} box-shadow: 0px 4px 8px 0px #00000024;
    ...
    >
      <div className='report_buy_plan w-[500px] rounded shadow-[0px_4px_8px_0px_rgb(0,0,0)]'>
        <body className='report_container border-0 pt-2 px-2 pb-5'>
          <div className='w-full flex items-center justify-between  text-center p-4 border border-[#D9D9D9] rounded-lg mb-5'> <div></div> رسید نهایی خرید اشتراک<img src='/img/modal/buyPlanReport/head/close.svg' className='float-left' onClick={() => handleClose()} /></div>
