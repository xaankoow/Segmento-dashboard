            ...
            return (
                <Fragment>
                    <div className="flex justify-between pl-4 pr-3 w-[580px] h-24 border border-[#D9D9D9] m-auto items-center">
                        ...
                        <button className='btn-style ' onClick={() => { setAddWebsitePageMap([...addWebsitePageMap, `${countInput}`]); handleAddStateCountInput("websitePage") }}><img src="/img/modal/workSpace/body/file_download.svg" className="ml-4" />دریافت فایل</button>
                        </div>
                    </div>
                    <div className="flex justify-between pl-4 pr-3 mt-4 w-[580px] h-24 border border-[#D9D9D9] m-auto items-center">
                        ...
                        <button className='btn-style ' onClick={() => { setAddWebsitePageMap([...addWebsitePageMap, `${countInput}`]); handleAddStateCountInput("websitePage") }}><img src="/img/modal/workSpace/body/beenhere.svg" className="ml-4" />تایید وبسایت</button>
                    </div>
                </Fragment>
            );
        default:
