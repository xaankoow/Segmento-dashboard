    ...
    return (
        <Fragment>
            <footer className=''>
                ...
                {stepModal == 1 ? (<AuthButton handlerClick={() => { setStepModal(stepModal + 1); setFree(true) }} textButton={<Fragment>14 روز رایگان <span className='forward-14_free_ico'></span></Fragment>} />) : stepModal == 5 ? <div></div> :null}
            </footer>
        </Fragment>
    )
}
