...
export default function FooterBtn({ stepModal,setFree, setStepModal }) {
    ...
    return (
        <footer className=' px-[18px]'>
            ...
            {stepModal == 1 ? <AuthButton handlerClick={() => { setFree(false) }} reduxHandleClick={buyPlan} textButton={"خرید اشتراک"} /> : <button className='btn-style' onClick={() => setStepModal(stepModal + 1)}>گام بعدی <span className='forward-ico'></span></button>}
