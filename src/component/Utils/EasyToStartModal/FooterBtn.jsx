    ...
    return (
        <Fragment>
            ...
            <footer className=''>
                ...
                {/* {stepModal == 1 ? <AuthButton handlerClick={() => { setStepModal(stepModal + 1); setFree(false) }} textButton={"خرید اشتراک"} />:                       stepModal == 2&free ? <AuthButton handlerClick={() => {!checkUseTryFree? setStepModal(stepModal + 1)():alert("") }} textButton={"فعال سازی"} disabled={!lockNextStep & stepModal == 2 & free ? true : false}/>                  : stepModal == 5 ? <AuthButton reduxHandleClick={modalSetWorkSpace} textButton={"پایان"}/> : stepModal == 6 ? <button className='btn-style' onClick={() => handleClose()}>مشاهده اشتراک<span className='forward-ico'></span></button> : stepModal == 3 ? <AuthButton handlerClick={() => { setStepModal(stepModal + 1) }} disabled={webAdress == "" ? true : false} textButton={<Fragment>گام بعدی <span className='forward-ico'></span></Fragment>} />: stepModal != 2 | free ? <button className='btn-style' onClick={() => setStepModal(stepModal + 1)} disabled={!lockNextStep & stepModal == 2 & free ? true : false}>گام بعدی <span className='forward-ico'></span></button> : ""} */}
                {/* {stepModal == 1 ? <AuthButton handlerClick={() => { setStepModal(stepModal + 1); setFree(false) }} textButton={"خرید اشتراک"} />:                       stepModal == 2&free ? <AuthButton reduxHandleClick={tryFreePlan} handlerClick={checkUseTryFree?setStepModal(stepModal + 1):""} textButton={"فعال سازی"} disabled={!lockNextStep & stepModal == 2 & free ? true : false}/>                  : stepModal == 5 ? <AuthButton reduxHandleClick={modalSetWorkSpace} textButton={"پایان"}/> : stepModal == 6 ? <button className='btn-style' onClick={() => handleClose()}>مشاهده اشتراک<span className='forward-ico'></span></button> : stepModal == 3 ? <AuthButton handlerClick={() => { setStepModal(stepModal + 1) }} disabled={webAdress == "" ? true : false} textButton={<Fragment>گام بعدی <span className='forward-ico'></span></Fragment>} />: stepModal != 2 | free ? <button className='btn-style' onClick={() => setStepModal(stepModal + 1)} disabled={!lockNextStep & stepModal == 2 & free ? true : false}>گام بعدی <span className='forward-ico'></span></button> : ""} */}
